...
function createForceLayout(nodes, edges) {
    ...
    var force = d3.layout.force().gravity(1.2).linkDistance(30).linkStrength(function (d) {
    ...
    node.append("text").text(function (d) {
        return d.weight >= 12 ? d.name: null
    }).style("font-size", 12).style("font-weight", 500).style("fill", "white").attr("dy", "1em").attr("dx", "1em");
